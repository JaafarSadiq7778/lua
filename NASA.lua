...
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'*عـزيـزي الـمـطـور ســورس 'ايـفا' تم حظره من الـصانـع بنجاح .*').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(NASA..'BaN:In:Tuasl',Info_User)  
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'*عـزيـزي الـمـطـور ســورس 'ايـفا' تم الـغاء حظره من الـصانـع بنجاح .*').Reply,"md",true)  
end 
end
end
...
send(msg.chat_id,msg.id,"*◍ اهلاً بك عـزيـري الـمـطور ســورس 'ايـفا'* \n","md",true, false, false, true, reply_markup)
return false 
end
...
{
{text = '🔘 | تواصل معنا', url = 't.me/WALED_AR_963'}, 
},
}
}
...
{
{text = '☢️ | اضغط هنا لتنصيب', url = 't.me/'}, 
},
{
{text = '🔘 | تواصل معنا', url = 't.me/WALED_AR_963'}, 
},
